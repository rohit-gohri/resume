...
\begin{rSection}{ Education }
    ...
    \\ B.E. in Computer Engineering, GPA: 7.35 \hfill%
...
\begin{rSection}{Work Experience}
    ...
    \begin{rSubsection}{\href{https://github.com/smartprix}{Smartprix}}
...
%------------------------------------------------
    ...
    \begin{rSubsection}{\href{https://github.com/rohit-smpx?tab=repositories&q=Woobus&type=public}{Woobus}}
...
% TODO: Move to single line in end
    ...
    \begin{rSubsection}
        ...
        % TODO: not consistent, other places have positions
        {NodeJS, MaterializeCSS, MongoDB}
            {NSIT} % TODO: Change to Delhi, IN
...
%     \begin{rSubsection}{The Alliance - NSIT's Newspaper}
...
%     \begin{rSubsection}{MDT Design Team}
%             { \mydate{3}{2014} - \mydate{6}{2017} }
%         {Creative Head}{NSIT} % TODO: NSIT should be in title
...
\newbox\vhbox
\newboolean{IncludeOldExtraCurriculars}
\setboolean{IncludeOldExtraCurriculars}{false}
...
\begin{rSection}{Extra-Currucular} \itemsep -3pt
    ...
    \setbox\vhbox\vbox{%
        \begin{rSubsection}
            {\href{https://www.facebook.com/mokshansit}{MDT Design Team}, {\normalfont \em Creative Head}}
                { \mydate{3}{2014} - \mydate{6}{2017} }
            {}{} % TODO: NSIT isn't mentioned anywhere
    ...
    \ifthenelse{\boolean{IncludeOldExtraCurriculars}}{
        \unvbox\vhbox
    }{ }
