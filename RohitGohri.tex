...
\begin{rSection}{Work Experience}
    ...
    \begin{rSubsection}
        ...
        \item Built an email library using NodeJS, Mailgun API, \textbf{Redis}, and PM2 queue workers
        ...
        \item Enabled static type checking of projects by adding \textbf{Typescript} typings to modules
        \item Responsible for production \textbf{deployments} and infrastructure configuration with PM2 \& \textbf{Ansible} 
...
\begin{rSection}{Projects}
    ...
    \begin{rSubsection}
        ...
        \item \href{https://github.com/danger/danger-js/pull/892}{\textbf{danger-js}}: Added feature to customize PR messages with different emojis \faHeart
    ...
    \begin{rSubsection}
        ...
        \item Worked on various features: user \& event management, social login, and email campaigns
...
\begin{rSection}{Extra-Currucular} \itemsep -3pt    
    \begin{rSubsection}
        ...
        \item Designed 8 editions and successfully oversaw the launch of 5 editions as Managing Editor
