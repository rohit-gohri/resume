...
\begin{rSection}{Skills}
    ...
    \begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
        ...
        Software \& Tools           & PM2, Nginx, Redis, PostgreSQL, Ansible, ElasticStack, Grafana, Docker \\
        Other                       & Linux, Bash, SSH, Git, Adobe Photoshop \& InDesign \\
    \end{tabular}
...
\begin{rSection}{Work Experience}
    ...
    \begin{rSubsection}
        {\href{https://github.com/smartprix}{Smartprix.com}}
        ...
        \item Generated dynamic popularity factor for products through \textbf{ElasticSearch} queries on visitor stats
        \item Enabled static type checking of projects by adding \textbf{Typescript} typings to our NodeJS modules
        \item Built automated \textbf{CI pipelines} to increase coverage by \textbf{26\%} and run integration tests across repositories
        \item Deployed a logging \& monitoring environment (ELK, \textbf{InfluxDB}) which gathers log, visit \& system data
...
\begin{rSection}{Projects}
    ...
    \begin{rSubsection}
        ...
        \item \href{https://github.com/web-push-libs/web-push/pull/456}{\textbf{web-push}}: Fixed bug where old GCM push endpoints stopped working after migrating to FCM
    \end{rSubsection}
...
\begin{rSection}{Extra-Currucular} \itemsep -3pt    
    \begin{rSubsection}
        ...
        \item Revamped the Wordpress website to be an archive of old editions and kick-start a blog
    \end{rSubsection}
