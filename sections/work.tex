...
\begin{rSubsection}
    ...
    \item Maintaining shared tooling in a \textbf{monorepo} for \textbf{authentication}, \textbf{SSR}, Redis caching, and DataDog logging
    \item Responsible for the \textbf{shared GraphQL API} backend built with Typescript, MongoDB, PubSub, and Big Query
    \item Working on common design system components and multiple NextJS applications, live in \textbf{30+ countries}
    \item Improving infrastructure automation using Terraform, custom \textbf{Helm Charts} and Drone CI
