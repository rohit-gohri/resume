...
\begin{rSubsection}
    ...
    \item Set up various tools for versioning, releases, codegen, and docs
    \item Integrating various GCP services: Pub/Sub, Cloud Tasks, Cloud Build
...
\begin{rSubsection}
    ...
    \item Setup serverless framework for handling \textbf{Billions of events from SQS}
