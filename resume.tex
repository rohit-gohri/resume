...
\begin{rSection}{Work Experience}
    ...
    \begin{rSubsection}
        ...
        \item Led a team to make website ready for US launch, working on VueJS admin, \textbf{NodeJS} backend, and GraphQL API
        ...
        \item Developed a script around Wal-E to take continuos backups of \textbf{PostgreSQL} DB and save weekly backups to GCS 
