...
\begin{rSection}{Skills}
    ...
    \begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
        ...
        Software \& Tools           & PM2, Nginx, Gitlab, Ansible, MongoDB, Redis, PostgreSQL, ElasticStack(ELK), Grafana, Docker \\
        Other                       & Linux, Bash, SSH, AWS, Git, LaTeX, Adobe Photoshop \& InDesign \\
    \end{tabular}
...
\begin{rSection}{Work Experience}
    ...
    \begin{rSubsection}
        ...
        { \fmtdate{1}{2019} - Present }
        {Sr. Software Developer}
        {Gurugram, IN}

        \item Leading company wide CI/CD adoption using \textbf{Gitlab CI/CD}
        \item Working as a Team Lead for a React, Node, MongoDB fullstack application
        \item Automating \textbf{AWS} infrastructure and deploys with \textbf{Ansible} and Gitlab
        \item Developing common NodeJS tooling for use across projects
...
\begin{rSection}{Projects}
    ...
    \begin{rSubsection}
        {\href{https://rohit.page/contributions}{Open Source Contributions}}
    ...
    \begin{rSubsection}
        ...
        \item \href{https://github.com/rohit-gohri/resume}{\textbf{This Resume}}: Built with Latex with automated builds using Drone.io
    \end{rSubsection}
    }
