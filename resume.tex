...
\begin{rSection}{Work Experience}
    \begin{rSubsection}
        ...
        \item Working with Typescript, NextJS, and GraphQL
        \item Helping with Github Actions for CI/CD
        \item Integrating GCP services: Pub/Sub, Cloud Tasks
    ...
    \begin{rSubsection}
        ...
        % \item Automated the project's \textbf{AWS} infrastructure and deploys with \textbf{Ansible}, PM2, and Gitlab
        % \item Making common tooling for use across projects, including for PM2, Postman, Release Management
        \item Integrating various services: Queues (SQS), Load Balancer (ALB), Logging (ELK), Metrics (InfluxDB)
...
\begin{rSection}{Extra-Curricular} \itemsep -3pt
    \begin{rSubsection}
        {\href{http://alliancensut.com/our-editions/}{The Alliance - NSIT's Newspaper}}
